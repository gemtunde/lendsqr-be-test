const logoUrl = "https://lendsqr.com/assets/icons/LSQ%20Logo.svg";
export const verifyEmailTemplate = (
  url: string,
  brandColor: string = "#2563EB"
) => ({
  subject: "Confirm your Lendsqr account",
  ...
  html: `
      <html><head><style>
        ...
        <div class="container">
        <div class="header">
  <img src="${logoUrl}" alt="Lendsqr" style="max-width: 40px; margin-bottom: 10px;" />
  Lendsqr
</div>
